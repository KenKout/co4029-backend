...
from abridgeai.features.discussions.router import (
    get_arq_pool as discussions_get_arq_pool,
)
...
from abridgeai.features.interviews.routers import (
    authoring_sessions_router as interviews_authoring_sessions_router,
)
from abridgeai.features.interviews.routers import (
...
from abridgeai.features.learning_programs.routers import (
    get_arq_pool as learning_programs_get_arq_pool,
)
from abridgeai.features.learning_programs.routers import (
...
async def _lifespan(app: FastAPI) -> AsyncIterator[None]:
    ...
    app.dependency_overrides[learning_programs_get_arq_pool] = _provide_arq_pool
    app.dependency_overrides[discussions_get_arq_pool] = _provide_arq_pool
...
def create_app() -> FastAPI:
    ...
    # Security & access summary (ADM-020). Same permission family as the audit
